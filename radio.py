...
# ============================================================
#  FLUX RADIO — Outre-mer 1ère (La 1ère)
# ============================================================
STATIONS = [
    # Antilles
    ("MARTINIQUE 1ÈRE", "https://martinique.ice.infomaniak.ch/martinique-128.mp3"),
    ("GUADELOUPE 1ÈRE", "https://guadeloupe.ice.infomaniak.ch/guadeloupe-128.mp3"),
    ("GUYANE 1ÈRE", "https://guyane.ice.infomaniak.ch/guyane-128.mp3"),
    # Océan Indien
    ("MAYOTTE 1ÈRE", "https://mayotte.ice.infomaniak.ch/mayotte-128.mp3"),
    ("RÉUNION 1ÈRE", "https://reunion.ice.infomaniak.ch/reunion-128.mp3"),
    # Pacifique
    ("NOUVELLE-CALÉDONIE 1ÈRE", "https://nouvellecaledonie.ice.infomaniak.ch/nouvellecaledonie-128.mp3"),
    ("POLYNÉSIE 1ÈRE", "https://polynesie.ice.infomaniak.ch/polynesie-128.mp3"),
    ("WALLIS-ET-FUTUNA 1ÈRE", "https://wallisfutuna.ice.infomaniak.ch/wallisfutuna-128.mp3"),
    # Atlantique Nord
    ("SAINT-PIERRE-ET-MIQUELON 1ÈRE", "https://saintpierremiquelon.ice.infomaniak.ch/saintpierremiquelon-128.mp3"),
]

# ============================================================
#  LIENS DU SITE OFFICIEL — Outre-mer La 1ère
# ============================================================
SITE_LINKS = {
    "portail":      ("Portail Outre-mer",     "https://la1ere.francetvinfo.fr/"),
    "radio":        ("Toutes les radios",     "https://la1ere.francetvinfo.fr/radio/"),
    # Territoires
    "martinique":   ("Martinique 1ère",       "https://la1ere.francetvinfo.fr/martinique/"),
    "guadeloupe":   ("Guadeloupe 1ère",       "https://la1ere.francetvinfo.fr/guadeloupe/"),
    "guyane":       ("Guyane 1ère",           "https://la1ere.francetvinfo.fr/guyane/"),
    "mayotte":      ("Mayotte 1ère",          "https://la1ere.francetvinfo.fr/mayotte/"),
    "reunion":      ("Réunion 1ère",          "https://la1ere.francetvinfo.fr/reunion/"),
    "nouvellecaledonie": ("Nouvelle-Calédonie 1ère", "https://la1ere.francetvinfo.fr/nouvellecaledonie/"),
    "polynesie":    ("Polynésie 1ère",        "https://la1ere.francetvinfo.fr/polynesie/"),
    "wallisfutuna": ("Wallis-et-Futuna 1ère", "https://la1ere.francetvinfo.fr/wallisfutuna/"),
    "saintpierremiquelon": ("Saint-Pierre-et-Miquelon 1ère", "https://la1ere.francetvinfo.fr/saintpierremiquelon/"),
}
...
class SitePopup(QDialog):
    ...
    Propose d'ouvrir les différentes sections du site Outre-mer La 1ère.
    """
    def __init__(self, parent=None):
        super().__init__(parent)
        ...
        title = QLabel("OUTRE-MER LA 1ÈRE")
        ...
        sub = QLabel("Ouvrir un site territorial")
        ...
        items = [
            ...
            ("polynesie",        "Polynésie"),
            ("wallisfutuna",     "Wallis-et-Futuna"),
            ("saintpierremiquelon","Saint-Pierre-et-Miquelon"),
        ]
    ...
    def _open_all(self):
        for key in ("portail", "radio", "martinique", "guadeloupe", "guyane",
                    "mayotte", "reunion", "nouvellecaledonie", "polynesie",
                    "wallisfutuna", "saintpierremiquelon"):
            if key in SITE_LINKS:
                _, url = SITE_LINKS[key]
                webbrowser.open(url)
        self.accept()
...
class Freedom(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RADIOS LA 1ÈRE")
        self.resize(450, 420)
